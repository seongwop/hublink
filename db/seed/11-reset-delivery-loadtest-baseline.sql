...
FROM (
    SELECT
        seq_num AS seq,
        'load-seoul-hub-delivery' AS prefix,
    ...
    SELECT
        seq_num AS seq,
        'load-busan-company-delivery' AS prefix,
    ...
    SELECT
        seq_num AS seq,
        'load-incheon-company-delivery' AS prefix,
