...
INSERT INTO user_service.p_users (
    ...
    ('50000000-0000-0000-0000-000000000000', 'master', '$2a$10$7EqJtq98hPqEX7fNZaFWoO.hHqpS7tb9mTIE6E3wEJGQRfPpB8G4u', '마스터 관리자', 'master@hublink.test', 'master', 'MASTER', 'APPROVED', null, null, now(), 'seed', now(), 'seed'),
    ('50000000-0000-0000-0000-000000000001', 'buyer-manager', '$2a$10$7EqJtq98hPqEX7fNZaFWoO.hHqpS7tb9mTIE6E3wEJGQRfPpB8G4u', '구매 담당자', 'buyer-manager@hublink.test', 'buyer-manager', 'COMPANY_MANAGER', 'APPROVED', null, '20000000-0000-0000-0000-000000000002', now(), 'seed', now(), 'seed'),
    ('50000000-0000-0000-0000-000000000002', 'seoul-hub-manager', '$2a$10$7EqJtq98hPqEX7fNZaFWoO.hHqpS7tb9mTIE6E3wEJGQRfPpB8G4u', '서울 허브 매니저', 'seoul-hub-manager@hublink.test', 'seoul-hub-manager', 'HUB_MANAGER', 'APPROVED', '10000000-0000-0000-0000-000000000001', null, now(), 'seed', now(), 'seed'),
    ('50000000-0000-0000-0000-000000000003', 'seoul-hub-delivery', '$2a$10$7EqJtq98hPqEX7fNZaFWoO.hHqpS7tb9mTIE6E3wEJGQRfPpB8G4u', '서울 허브 배송담당자', 'seoul-hub-delivery@hublink.test', 'seoul-hub-delivery', 'DELIVERY_MANAGER', 'APPROVED', '10000000-0000-0000-0000-000000000001', null, now(), 'seed', now(), 'seed'),
    ('50000000-0000-0000-0000-000000000004', 'busan-company-delivery', '$2a$10$7EqJtq98hPqEX7fNZaFWoO.hHqpS7tb9mTIE6E3wEJGQRfPpB8G4u', '부산 업체 배송담당자', 'busan-company-delivery@hublink.test', 'busan-company-delivery', 'DELIVERY_MANAGER', 'APPROVED', '10000000-0000-0000-0000-000000000002', null, now(), 'seed', now(), 'seed'),
    ('50000000-0000-0000-0000-000000000005', 'incheon-company-delivery', '$2a$10$7EqJtq98hPqEX7fNZaFWoO.hHqpS7tb9mTIE6E3wEJGQRfPpB8G4u', '인천 업체 배송담당자', 'incheon-company-delivery@hublink.test', 'incheon-company-delivery', 'DELIVERY_MANAGER', 'APPROVED', '10000000-0000-0000-0000-000000000003', null, now(), 'seed', now(), 'seed')
