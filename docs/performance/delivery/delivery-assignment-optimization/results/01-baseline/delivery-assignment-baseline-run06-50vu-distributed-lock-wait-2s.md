# Delivery Assignment Baseline Run 06 - 50VU Distributed No Sleep, Lock Wait 2s 결과
...
| 항목 | 값 |
| --- | --- |
| 테스트명 | Delivery Assignment Baseline Run 06 - 50VU Distributed No Sleep, Lock Wait 2s |
